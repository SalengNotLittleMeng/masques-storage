...
class c {
  ...
  get(e, t = !1) {
    ...
    const s = h(this.storageHandler.get(e));
    return console.log(s), this.handlerGetMethods ? handlerGetMethods(s) : s && s.value;
  }
  set(e, t = !1) {
    Object.keys(e).forEach((s) => {
      ...
      i.value = e[s], this.handlerSetMethods && this.handlerSetMethods(i), this.storageHandler.set(s, JSON.stringify(i));
    });
  }
  delete(e) {
