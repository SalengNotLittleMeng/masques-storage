...
class h {
  ...
  set(e, t = {}) {
    Object.keys(e).forEach((s) => {
      ...
      a.value = e[s], this.handlerSetMethods && this.handlerSetMethods(a, t), this.storageHandler.set(s, JSON.stringify(a));
    });
  }
  delete(e) {
  ...
  has(e) {
    return this.storageHandler.has(e);
  }
  clear() {
...
class i extends h {
  ...
  handlerGetMethods(e, t) {
    const s = e.value;
    return l(e) && this.storageHandler.delete(t), s;
  }
}
class u {
  constructor(e) {
